...
create index if not exists idx_themes_article_count
on themes (article_count desc);
...
create index if not exists idx_theme_article_links_matched_at
on theme_article_links (matched_at desc);
